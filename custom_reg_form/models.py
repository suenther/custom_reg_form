...
class ExtraInfo(models.Model):
    ...
    current_semester_of_study = models.CharField(verbose_name="Please enter your current semester of study.", choices=STUDY_LEVEL_CHOICES, max_length=15)

    part_time_student = models.CharField(verbose_name="Are you a part-time student?", choices=NO_YES, max_length=15)

    bachelor_level_statistics = models.CharField(verbose_name="Have you taken a bachelor's-level statistics or data analytics course before?", choices=NO_YES, max_length=100)
    master_level_statistics = models.CharField(verbose_name="Have you taken a master's-level statistics or data analytics course before?", choices=NO_YES, max_length=100)

    familiar_with_R = models.CharField(verbose_name="Are you familiar with the programming language R?", choices=NO_YES, max_length=50)

    #Likert Please rate your level of agreement with the following statements:
    importance_DAEI = models.CharField(verbose_name="Data analytics is important for my future career.", choices=LIKERT_CHOICES, max_length=100)
    motivation_DAEI = models.CharField(verbose_name="It is important to me to achieve a very good grade (between 1.0 and 1.7) in the IITP course.", choices=LIKERT_CHOICES, max_length=100)

    #Likert
    procrastinate =  models.CharField(verbose_name="How often do you procrastinate?", choices=LIKERT_CHOICES, max_length=80)

    #Likert Do you often ...
    measure_self_set_goals = models.CharField(verbose_name="Do you often measure your performance against self-set goals?", choices=LIKERT_CHOICES, max_length=100)
    measure_around_you = models.CharField(verbose_name="Do you often measure your performance against the performance of people around you?", choices=LIKERT_CHOICES, max_length=100)

    more_time_on_course = models.CharField(max_length=30, verbose_name="What do you think? How many out of 100 students will spend more time on the IITP course than you do?")

    course_how_many_students_studying = models.CharField(max_length=30, verbose_name="What do you think? How many out of 100 students will spend more time studying this semester than you do?")
    ...
    list_lang = models.CharField(verbose_name="What is your native language?", choices=LANGUAGES_CHOICES_REDUCED, max_length=120)

    #notenziel self-assigned goals (Locke & Latham, 1990)/ grade expactation (Lane & Gibbons, 2007)
    #open scale
    scale_gradegoal1 = models.CharField(choices=GRADE_CHOICES, max_length=80, verbose_name="What is the minimum (i.e. the least you would be satisfied with) grade goal for the final exam?")
    scale_gradegoal2 = models.CharField(choices=GRADE_CHOICES, max_length=80, verbose_name="Which grade do you aim for in the final exam?")
